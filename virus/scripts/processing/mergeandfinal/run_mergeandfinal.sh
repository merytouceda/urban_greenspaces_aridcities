...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/virus/mergeandfinal/config.sh
...
echo "launching mergeandfinal.slurm"

JOB_ID=`sbatch --job-name mergeandfinal -a 1-$NUM_JOB mergeandfinal.slurm`
