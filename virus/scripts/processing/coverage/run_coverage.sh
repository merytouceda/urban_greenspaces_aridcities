...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/virus/coverage/config.sh
...
echo "launching coverage.slurm as a job."

JOB_ID=`sbatch --job-name coverage -a 1-$NUM_JOB coverage.slurm`
