...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/virus/vs2/config.sh
...
echo "launching vs2.slurm as a job."

JOB_ID=`sbatch --job-name vs2 -a 1-$NUM_JOB /groups/egornish/mtoucedasuarez/scripts/jobs/urban/virus/vs2/vs2.slurm`
