...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/virus/vcontact2/config.sh
...
echo "launching vcontact2.slurm"

JOB_ID=`sbatch --job-name vcontact2 -a 1-$NUM_JOB vcontact2.slurm`
