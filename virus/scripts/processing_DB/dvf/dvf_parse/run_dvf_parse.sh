...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/virus/dvf/dvf_parse/config.sh
...
JOB_ID=`sbatch --job-name dvf_parse --export=IN_LIST -a 1-$NUM_JOB dvf_parse.slurm`
