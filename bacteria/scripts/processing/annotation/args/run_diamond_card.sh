...
echo "launching /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/args/diamond_card.slurm as a job."

JOB_ID=`sbatch --job-name diamondcard -a 1-$NUM_JOB /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/args/diamond_card.slurm`
