...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/args/mapping/config.sh
...
echo "launching bwa_resfinder.slurm"

JOB_ID=`sbatch --job-name bwa_species -a 1-$NUM_JOB bwa_resfinder.slurm`
