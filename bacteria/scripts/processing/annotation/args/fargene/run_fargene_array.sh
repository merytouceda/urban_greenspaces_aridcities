...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/args/fargene/config.sh
...
echo "launching fargene_array.slurm as a job."

JOB_ID=`sbatch --job-name lu_fargene_array -a 1-$NUM_JOB fargene_array.slurm`
