...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/carbon/config.sh
...
echo "launching diamond_carbon_array.slurm as a job."

JOB_ID=`sbatch --job-name LU_carbon_strict -a 1-$NUM_JOB diamond_carbon_array.slurm`
