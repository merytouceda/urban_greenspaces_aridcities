...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/args/card/config.sh
...
echo "launching diamond_card.slurm as a job."

JOB_ID=`sbatch --job-name diamondcard -a 1-$NUM_JOB diamond_card.slurm`
