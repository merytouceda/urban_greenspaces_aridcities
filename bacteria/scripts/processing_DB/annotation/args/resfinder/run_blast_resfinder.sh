...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/args/resfinder/config.sh
...
echo "launching blast_resfinder.slurm as a job."

JOB_ID=`sbatch --job-name blastresfinder -a 1-$NUM_JOB blast_resfinder.slurm`
