...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/carbon/config.sh
...
echo "launching diamond_c_array.slurm as a job."

JOB_ID=`sbatch --job-name urb_c_strict -a 1-$NUM_JOB diamond_c_array.slurm`
