...
source /groups/egornish/mtoucedasuarez/scripts/jobs/urban/nitrogen/config.sh
...
echo "launching diamond_n_array.slurm as a job."

JOB_ID=`sbatch --job-name urb_n_strict -a 1-$NUM_JOB diamond_n_array.slurm`
