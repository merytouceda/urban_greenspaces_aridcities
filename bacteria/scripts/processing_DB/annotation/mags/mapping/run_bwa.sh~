...
source /groups/egornish/mtoucedasuarez/scripts/jobs/landuse/mags/mapping/config.sh
...
echo "launching bwa_mags.slurm"

JOB_ID=`sbatch --job-name bwa_species -a 1-$NUM_JOB bwa_mags.slurm`
